# Adapted from Kelvin Chow's invertcontrast.py, https://github.com/kspaceKelvin/python-ismrmrd-server/blob/master/invertcontrast.py
import ismrmrd
import os
import itertools
import logging
    ...
    try:
        for item in connection:
            ...
            if isinstance(item, ismrmrd.Acquisition):
                SetLog.log_AcquisitionAll(item)
            ...
            # ----------------------------------------------------------
                ...
                # set_Log
                SetCollector.log_ImageHead(item)

                # send straight through
                tmpMeta = ismrmrd.Meta.deserialize(item.attribute_string)
                SetCollector.log_ImageMeta(tmpMeta)
        ...
        setLogs_string = SetCollector.get_SetLogs()
        logging.info("================ SET LOG INFO ========================")
        logging.info(setLogs_string)
        logging.info("======================================================")
