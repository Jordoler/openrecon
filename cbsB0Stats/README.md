...
Container is available on the [Neurocontainers openrecon](https://github.com/neurodesk/openrecon/tree/main) repository
...
+ The mean and standard deviation are calculated and displayed in the image comments as well as in the logs.
